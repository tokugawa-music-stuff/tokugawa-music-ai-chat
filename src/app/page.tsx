...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-dvh bg-[#FFFBBA] text-slate-800">
      ...
      {/* ヘッダー */}
      <header className="bg-[#12A182] text-white px-4 py-3 shadow-sm flex items-center justify-center">
  ...
  こんにちは！徳川ミュージックアカデミーです！
   ...
   <div
  className={`max-w-[90%] sm:max-w-[82%] md:max-w-[72%] rounded-2xl px-4 py-3 shadow-sm text-[15px] font-medium leading-7 whitespace-pre-wrap ${
    msg.role === 'user'
